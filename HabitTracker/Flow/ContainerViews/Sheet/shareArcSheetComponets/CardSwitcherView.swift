...
struct CardSwitcherView: View {
    ...
    var body: some View {
        VStack {
            ...
            HStackSnap(selectedIndex: $selectedCard, layoutRefreshTrigger: $layoutRefreshTrigger , selectedLeadingOffset: 0, nextCardIndex: 0, shouldAutoScrollCard: false , alignment: .center(UIScreen.main.bounds.width * 0.14)) {
